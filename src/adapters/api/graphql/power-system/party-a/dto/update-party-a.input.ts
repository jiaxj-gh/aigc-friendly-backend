...
import { UpdatePowerSupplyInput } from './update-power-supply.input';

@InputType()
export class UpdatePartyAInput {
  ...
  @Field(() => [UpdatePowerSupplyInput], {
    nullable: true,
    description: '供电信息列表，传入时按全量覆盖处理',
  })
  @IsOptional()
  @IsArray({ message: '供电信息必须是数组' })
  @ValidateNested({ each: true })
  @Type(() => UpdatePowerSupplyInput)
  powerSupplyInfo?: UpdatePowerSupplyInput[];
}
