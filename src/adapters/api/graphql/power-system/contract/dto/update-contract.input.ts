...
import { UpdateContractQuotationInput } from './update-contract-quotation.input';

@InputType()
export class UpdateContractInput {
  @Field(() => Int, { description: '合同 ID' })
  @IsNumber({}, { message: '合同 ID 必须是数字' })
  contractId!: number;
  ...
  @Field(() => String, { nullable: true, description: '甲方合同编号' })
  @IsOptional()
  @IsString({ message: '甲方合同编号必须是字符串' })
  @MaxLength(100, { message: '甲方合同编号长度不能超过 100' })
  partyAContractNo?: string;

  @Field(() => String, { nullable: true, description: '乙方合同编号' })
  @IsOptional()
  ...
  @Field(() => String, { nullable: true, description: '甲方签署日期' })
  @IsOptional()
  @IsString({ message: '甲方签署日期必须是字符串' })
  partyASignDate?: string;

  @Field(() => String, { nullable: true, description: '乙方签署日期' })
  @IsOptional()
  ...
  @Field(() => String, { nullable: true, description: '签署地点' })
  @IsOptional()
  ...
  @Field(() => Int, { nullable: true, description: '乙方 ID' })
  @IsOptional()
  @IsNumber({}, { message: '乙方 ID 必须是数字' })
  partyBId?: number;

  @Field(() => UpdateContractQuotationInput, { nullable: true, description: '报价信息' })
  @IsOptional()
  @ValidateNested()
  @Type(() => UpdateContractQuotationInput)
  quotation?: UpdateContractQuotationInput;
}
