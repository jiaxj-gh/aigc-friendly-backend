...
export class BackfillPowerSystemActualPowerConsumptionIntervalColumnsFromLegacyTable1773929200000 implements MigrationInterface {
  name = 'BackfillPowerSystemActualPowerConsumptionIntervalColumnsFromLegacyTable1773929200000';

  public async up(queryRunner: QueryRunner): Promise<void> {
    const legacyTableExists = await hasLegacyTable(queryRunner, 'actual_power_consumption');
